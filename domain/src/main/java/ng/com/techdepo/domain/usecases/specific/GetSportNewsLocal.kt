...
class GetSportNewsLocal @Inject constructor(private val newsRepository: NewsRepository, private val postExecutionThread: PostExecutionThread) :
    ...
    override fun buildUseCaseFlowable(params: Nothing?): Flowable<List<Article>> {
        return newsRepository.getSportNewsLocal()
    }
